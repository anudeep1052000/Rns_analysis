...
mass[jb11] = 0.016430486140895328
...
mass[jne22] = 0.032820340870865106
...
mass[js30] = 0.04475001716634224
mass[js31] = 0.04623445115717168
mass[js32] = 0.04771569725373347
mass[js33] = 0.04920720158403909
mass[jcl33] = 0.04921614582850528
mass[jcl34] = 0.05070305756947744
mass[jcl35] = 0.05218814819637857
mass[jar34] = 0.05071276964379744
mass[jar36] = 0.05367861481161837
mass[jar37] = 0.055169885517654185
mass[jar38] = 0.056656267963553525
mass[jar39] = 0.05815104578297151
mass[jk39] = 0.05815014024074886
mass[jca40] = 0.05964089333318169
mass[jsc43] = 0.06411599795281459
mass[jti44] = 0.06560623627711017
mass[jv47] = 0.07007634727747114
...
def rhs_eq(t, Y, rho, T, screen_func):
    ...
    dYdt[jn] = (
          ...
          ( -rho*Y[jn]*Y[jne21]*rate_eval.n_Ne21__Ne22 +Y[jne22]*rate_eval.Ne22__n_Ne21 ) +
          ...
          ( -rho*Y[jn]*Y[js30]*rate_eval.n_S30__S31 +Y[js31]*rate_eval.S31__n_S30 ) +
          ( -rho*Y[jn]*Y[js31]*rate_eval.n_S31__S32 +Y[js32]*rate_eval.S32__n_S31 ) +
          ( -rho*Y[jn]*Y[js32]*rate_eval.n_S32__S33 +Y[js33]*rate_eval.S33__n_S32 ) +
          ( -rho*Y[jn]*Y[jcl33]*rate_eval.n_Cl33__Cl34 +Y[jcl34]*rate_eval.Cl34__n_Cl33 ) +
          ( -rho*Y[jn]*Y[jcl34]*rate_eval.n_Cl34__Cl35 +Y[jcl35]*rate_eval.Cl35__n_Cl34 ) +
          ( -rho*Y[jn]*Y[jar36]*rate_eval.n_Ar36__Ar37 +Y[jar37]*rate_eval.Ar37__n_Ar36 ) +
          ( -rho*Y[jn]*Y[jar37]*rate_eval.n_Ar37__Ar38 +Y[jar38]*rate_eval.Ar38__n_Ar37 ) +
          ( -rho*Y[jn]*Y[jar38]*rate_eval.n_Ar38__Ar39 +Y[jar39]*rate_eval.Ar39__n_Ar38 ) +
          ( -rho*Y[jn]*Y[jni58]*rate_eval.n_Ni58__Ni59 +Y[jni59]*rate_eval.Ni59__n_Ni58 ) +
          ( +rho*Y[jhe4]*Y[jb11]*rate_eval.He4_B11__n_N14 -rho*Y[jn]*Y[jn14]*rate_eval.n_N14__He4_B11 ) +
          ...
          ( -rho*Y[jn]*Y[jna22]*rate_eval.n_Na22__p_Ne22 +rho*Y[jp]*Y[jne22]*rate_eval.p_Ne22__n_Na22 ) +
          ...
          ( -rho*Y[jn]*Y[jmg25]*rate_eval.n_Mg25__He4_Ne22 +rho*Y[jhe4]*Y[jne22]*rate_eval.He4_Ne22__n_Mg25 ) +
          ...
          ( -rho*Y[jn]*Y[js30]*rate_eval.n_S30__p_P30 +rho*Y[jp]*Y[jp30]*rate_eval.p_P30__n_S30 ) +
          ...
          ( -rho*Y[jn]*Y[js33]*rate_eval.n_S33__He4_Si30 +rho*Y[jhe4]*Y[jsi30]*rate_eval.He4_Si30__n_S33 ) +
          ( -rho*Y[jn]*Y[jcl33]*rate_eval.n_Cl33__p_S33 +rho*Y[jp]*Y[js33]*rate_eval.p_S33__n_Cl33 ) +
          ( -rho*Y[jn]*Y[jcl33]*rate_eval.n_Cl33__He4_P30 +rho*Y[jhe4]*Y[jp30]*rate_eval.He4_P30__n_Cl33 ) +
          ( -rho*Y[jn]*Y[jcl34]*rate_eval.n_Cl34__He4_P31 +rho*Y[jhe4]*Y[jp31]*rate_eval.He4_P31__n_Cl34 ) +
          ( -rho*Y[jn]*Y[jar34]*rate_eval.n_Ar34__p_Cl34 +rho*Y[jp]*Y[jcl34]*rate_eval.p_Cl34__n_Ar34 ) +
          ( -rho*Y[jn]*Y[jar34]*rate_eval.n_Ar34__He4_S31 +rho*Y[jhe4]*Y[js31]*rate_eval.He4_S31__n_Ar34 ) +
          ( -rho*Y[jn]*Y[jar36]*rate_eval.n_Ar36__He4_S33 +rho*Y[jhe4]*Y[js33]*rate_eval.He4_S33__n_Ar36 ) +
          ( -rho*Y[jn]*Y[jk39]*rate_eval.n_K39__p_Ar39 +rho*Y[jp]*Y[jar39]*rate_eval.p_Ar39__n_K39 ) +
          ( -rho*Y[jn]*Y[jca40]*rate_eval.n_Ca40__He4_Ar37 +rho*Y[jhe4]*Y[jar37]*rate_eval.He4_Ar37__n_Ca40 ) +
          ( -rho*Y[jn]*Y[jco55]*rate_eval.n_Co55__p_Fe55 +rho*Y[jp]*Y[jfe55]*rate_eval.p_Fe55__n_Co55 ) +
          ( -rho*Y[jn]*Y[jni58]*rate_eval.n_Ni58__He4_Fe55 +rho*Y[jhe4]*Y[jfe55]*rate_eval.He4_Fe55__n_Ni58 )
       )

    dYdt[jp] = (
          +Y[jn]*rate_eval.n__p__weak__wc12  +
          ( -rho*Y[jp]*Y[jb11]*rate_eval.p_B11__C12 +Y[jc12]*rate_eval.C12__p_B11 ) +
          ...
          ( -rho*Y[jp]*Y[jne22]*rate_eval.p_Ne22__Na23 +Y[jna23]*rate_eval.Na23__p_Ne22 ) +
          ...
          ( -rho*Y[jp]*Y[jp29]*rate_eval.p_P29__S30 +Y[js30]*rate_eval.S30__p_P29 ) +
          ...
          ( -rho*Y[jp]*Y[js32]*rate_eval.p_S32__Cl33 +Y[jcl33]*rate_eval.Cl33__p_S32 ) +
          ( -rho*Y[jp]*Y[js33]*rate_eval.p_S33__Cl34 +Y[jcl34]*rate_eval.Cl34__p_S33 ) +
          ( -rho*Y[jp]*Y[jcl33]*rate_eval.p_Cl33__Ar34 +Y[jar34]*rate_eval.Ar34__p_Cl33 ) +
          ( -rho*Y[jp]*Y[jcl35]*rate_eval.p_Cl35__Ar36 +Y[jar36]*rate_eval.Ar36__p_Cl35 ) +
          ( -rho*Y[jp]*Y[jar38]*rate_eval.p_Ar38__K39 +Y[jk39]*rate_eval.K39__p_Ar38 ) +
          ( -rho*Y[jp]*Y[jk39]*rate_eval.p_K39__Ca40 +Y[jca40]*rate_eval.Ca40__p_K39 ) +
          ( -rho*Y[jp]*Y[jsc43]*rate_eval.p_Sc43__Ti44 +Y[jti44]*rate_eval.Ti44__p_Sc43 ) +
          ( -rho*Y[jp]*Y[jv47]*rate_eval.p_V47__Cr48 +Y[jcr48]*rate_eval.Cr48__p_V47 ) +
          ( -rho*Y[jp]*Y[jmn51]*rate_eval.p_Mn51__Fe52 +Y[jfe52]*rate_eval.Fe52__p_Mn51 ) +
          ( -rho*Y[jp]*Y[jco55]*rate_eval.p_Co55__Ni56 +Y[jni56]*rate_eval.Ni56__p_Co55 ) +
          ...
          ( +rho*Y[jn]*Y[jp30]*rate_eval.n_P30__p_Si30 -rho*Y[jp]*Y[jsi30]*rate_eval.p_Si30__n_P30 ) +
          ( +rho*Y[jhe4]*Y[jp30]*rate_eval.He4_P30__p_S33 -rho*Y[jp]*Y[js33]*rate_eval.p_S33__He4_P30 ) +
          ( -rho*Y[jp]*Y[jp31]*rate_eval.p_P31__He4_Si28 +rho*Y[jhe4]*Y[jsi28]*rate_eval.He4_Si28__p_P31 ) +
          ( +rho*Y[jn]*Y[js30]*rate_eval.n_S30__p_P30 -rho*Y[jp]*Y[jp30]*rate_eval.p_P30__n_S30 ) +
          ( +rho*Y[jhe4]*Y[js30]*rate_eval.He4_S30__p_Cl33 -rho*Y[jp]*Y[jcl33]*rate_eval.p_Cl33__He4_S30 ) +
          ( +rho*Y[jn]*Y[js31]*rate_eval.n_S31__p_P31 -rho*Y[jp]*Y[jp31]*rate_eval.p_P31__n_S31 ) +
          ( +rho*Y[jhe4]*Y[js31]*rate_eval.He4_S31__p_Cl34 -rho*Y[jp]*Y[jcl34]*rate_eval.p_Cl34__He4_S31 ) +
          ( +rho*Y[jn]*Y[jcl33]*rate_eval.n_Cl33__p_S33 -rho*Y[jp]*Y[js33]*rate_eval.p_S33__n_Cl33 ) +
          ( +rho*Y[jhe4]*Y[jcl33]*rate_eval.He4_Cl33__p_Ar36 -rho*Y[jp]*Y[jar36]*rate_eval.p_Ar36__He4_Cl33 ) +
          ( +rho*Y[jhe4]*Y[jcl34]*rate_eval.He4_Cl34__p_Ar37 -rho*Y[jp]*Y[jar37]*rate_eval.p_Ar37__He4_Cl34 ) +
          ( -rho*Y[jp]*Y[jcl35]*rate_eval.p_Cl35__He4_S32 +rho*Y[jhe4]*Y[js32]*rate_eval.He4_S32__p_Cl35 ) +
          ( +rho*Y[jhe4]*Y[jcl35]*rate_eval.He4_Cl35__p_Ar38 -rho*Y[jp]*Y[jar38]*rate_eval.p_Ar38__He4_Cl35 ) +
          ( +rho*Y[jn]*Y[jar34]*rate_eval.n_Ar34__p_Cl34 -rho*Y[jp]*Y[jcl34]*rate_eval.p_Cl34__n_Ar34 ) +
          ( +rho*Y[jn]*Y[jk39]*rate_eval.n_K39__p_Ar39 -rho*Y[jp]*Y[jar39]*rate_eval.p_Ar39__n_K39 ) +
          ( -rho*Y[jp]*Y[jk39]*rate_eval.p_K39__He4_Ar36 +rho*Y[jhe4]*Y[jar36]*rate_eval.He4_Ar36__p_K39 ) +
          ( -rho*Y[jp]*Y[jsc43]*rate_eval.p_Sc43__He4_Ca40 +rho*Y[jhe4]*Y[jca40]*rate_eval.He4_Ca40__p_Sc43 ) +
          ( -rho*Y[jp]*Y[jv47]*rate_eval.p_V47__He4_Ti44 +rho*Y[jhe4]*Y[jti44]*rate_eval.He4_Ti44__p_V47 ) +
          ( +rho*Y[jhe4]*Y[jcr48]*rate_eval.He4_Cr48__p_Mn51 -rho*Y[jp]*Y[jmn51]*rate_eval.p_Mn51__He4_Cr48 ) +
          ( +rho*Y[jhe4]*Y[jfe52]*rate_eval.He4_Fe52__p_Co55 -rho*Y[jp]*Y[jco55]*rate_eval.p_Co55__He4_Fe52 ) +
          ( +rho*Y[jn]*Y[jco55]*rate_eval.n_Co55__p_Fe55 -rho*Y[jp]*Y[jfe55]*rate_eval.p_Fe55__n_Co55 ) +
          ( +rho*Y[jhe4]*Y[jco55]*rate_eval.He4_Co55__p_Ni58 -rho*Y[jp]*Y[jni58]*rate_eval.p_Ni58__He4_Co55 ) +
          ( -rho*Y[jp]*Y[jb11]*rate_eval.p_B11__He4_He4_He4 +1.66666666666667e-01*rho**2*Y[jhe4]**3*rate_eval.He4_He4_He4__p_B11 )
       )
    ...
    dYdt[jhe4] = (
          ...
          ( -rho*Y[jhe4]*Y[jne22]*rate_eval.He4_Ne22__Mg26 +Y[jmg26]*rate_eval.Mg26__He4_Ne22 ) +
          ...
          ( -rho*Y[jhe4]*Y[jsi26]*rate_eval.He4_Si26__S30 +Y[js30]*rate_eval.S30__He4_Si26 ) +
          ( -rho*Y[jhe4]*Y[jsi28]*rate_eval.He4_Si28__S32 +Y[js32]*rate_eval.S32__He4_Si28 ) +
          ( -rho*Y[jhe4]*Y[jsi29]*rate_eval.He4_Si29__S33 +Y[js33]*rate_eval.S33__He4_Si29 ) +
          ( -rho*Y[jhe4]*Y[jp29]*rate_eval.He4_P29__Cl33 +Y[jcl33]*rate_eval.Cl33__He4_P29 ) +
          ...
          ( -rho*Y[jhe4]*Y[js30]*rate_eval.He4_S30__Ar34 +Y[jar34]*rate_eval.Ar34__He4_S30 ) +
          ( -rho*Y[jhe4]*Y[js32]*rate_eval.He4_S32__Ar36 +Y[jar36]*rate_eval.Ar36__He4_S32 ) +
          ( -rho*Y[jhe4]*Y[js33]*rate_eval.He4_S33__Ar37 +Y[jar37]*rate_eval.Ar37__He4_S33 ) +
          ( -rho*Y[jhe4]*Y[jcl35]*rate_eval.He4_Cl35__K39 +Y[jk39]*rate_eval.K39__He4_Cl35 ) +
          ( -rho*Y[jhe4]*Y[jar36]*rate_eval.He4_Ar36__Ca40 +Y[jca40]*rate_eval.Ca40__He4_Ar36 ) +
          ( -rho*Y[jhe4]*Y[jk39]*rate_eval.He4_K39__Sc43 +Y[jsc43]*rate_eval.Sc43__He4_K39 ) +
          ( -rho*Y[jhe4]*Y[jca40]*rate_eval.He4_Ca40__Ti44 +Y[jti44]*rate_eval.Ti44__He4_Ca40 ) +
          ( -rho*Y[jhe4]*Y[jsc43]*rate_eval.He4_Sc43__V47 +Y[jv47]*rate_eval.V47__He4_Sc43 ) +
          ( -rho*Y[jhe4]*Y[jti44]*rate_eval.He4_Ti44__Cr48 +Y[jcr48]*rate_eval.Cr48__He4_Ti44 ) +
          ( -rho*Y[jhe4]*Y[jv47]*rate_eval.He4_V47__Mn51 +Y[jmn51]*rate_eval.Mn51__He4_V47 ) +
          ( -rho*Y[jhe4]*Y[jcr48]*rate_eval.He4_Cr48__Fe52 +Y[jfe52]*rate_eval.Fe52__He4_Cr48 ) +
          ( -rho*Y[jhe4]*Y[jmn51]*rate_eval.He4_Mn51__Co55 +Y[jco55]*rate_eval.Co55__He4_Mn51 ) +
          ( -rho*Y[jhe4]*Y[jfe52]*rate_eval.He4_Fe52__Ni56 +Y[jni56]*rate_eval.Ni56__He4_Fe52 ) +
          ( -rho*Y[jhe4]*Y[jfe55]*rate_eval.He4_Fe55__Ni59 +Y[jni59]*rate_eval.Ni59__He4_Fe55 ) +
          ( -rho*Y[jhe4]*Y[jb11]*rate_eval.He4_B11__n_N14 +rho*Y[jn]*Y[jn14]*rate_eval.n_N14__He4_B11 ) +
          ...
          ( -rho*Y[jhe4]*Y[jco55]*rate_eval.He4_Co55__p_Ni58 +rho*Y[jp]*Y[jni58]*rate_eval.p_Ni58__He4_Co55 ) +
          ( +rho*Y[jn]*Y[jni58]*rate_eval.n_Ni58__He4_Fe55 -rho*Y[jhe4]*Y[jfe55]*rate_eval.He4_Fe55__n_Ni58 ) +
          ( + 3*rho*Y[jp]*Y[jb11]*rate_eval.p_B11__He4_He4_He4 + -3*1.66666666666667e-01*rho**2*Y[jhe4]**3*rate_eval.He4_He4_He4__p_B11 ) +
